...
const DataEntryPage = lazy(() => import('@/pages/data-entry').then((m) => ({ default: m.DataEntryPage })))
const DataSourcePage = lazy(() => import('@/pages/data-source').then((m) => ({ default: m.DataSourcePage })))
const SettingsPage = lazy(() => import('@/pages/settings').then((m) => ({ default: m.SettingsPage })))
const AchievementXLCGSFPage = lazy(() => import('@/pages/achievement-xlc-gsf').then((m) => ({ default: m.AchievementXLCGSFPage })))
const AchievementWOPage = lazy(() => import('@/pages/achievement-wo').then((m) => ({ default: m.AchievementWOPage })))
const AchievementEXPOPage = lazy(() => import('@/pages/achievement-expo').then((m) => ({ default: m.AchievementEXPOPage })))
const PrioXLCPage = lazy(() => import('@/pages/prio-xlc').then((m) => ({ default: m.PrioXLCPage })))
const WOAgentPage = lazy(() => import('@/pages/wo-agent').then((m) => ({ default: m.WOAgentPage })))
